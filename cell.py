...
class Cell:
    ...
    def draw(self):
        ...
        if self.has_bottom_wall:
            self.window.draw_line(Line(bottom_left, bottom_right))
        if self.has_top_wall:
            self.window.draw_line(Line(top_left, top_right))
        if self.has_left_wall:
            self.window.draw_line(Line(top_left, bottom_left))
        if self.has_right_wall:
            self.window.draw_line(Line(top_right, bottom_right))
